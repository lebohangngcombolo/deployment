...
class _AssessmentPageState extends State<AssessmentPage> {
  ...
  Future<void> fetchAssessment() async {
    ...
    try {
      final res = await http.get(
        Uri.parse(
            "https://d694eb53771c.ngrok-free.app/api/candidate/applications/${widget.applicationId}/assessment"),
        headers: {
  ...
  Future<void> saveDraftAndExit() async {
    ...
    try {
      ...
      final res = await http.post(
        Uri.parse(
            "https://d694eb53771c.ngrok-free.app/api/candidate/apply/save_draft/${widget.applicationId}"),
        headers: {
          "Content-Type": "application/json",
          "Authorization": "Bearer $token"
        },
